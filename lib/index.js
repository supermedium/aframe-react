...
var Animation = exports.Animation = function (_React$Component) {
  ...
  function Animation() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Animation.__proto__ || Object.getPrototypeOf(Animation)).call.apply(_ref, [this].concat(args))), _this), _this.attachEvents = function (el) {
      if (el) {
...
var Entity = exports.Entity = function (_React$Component2) {
  ...
  function Entity() {
    ...
    return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref2 = Entity.__proto__ || Object.getPrototypeOf(Entity)).call.apply(_ref2, [this].concat(args))), _this2), _this2.attachEvents = function (el) {
      if (el) {
...
var Scene = exports.Scene = function (_React$Component3) {
  ...
  function Scene() {
    ...
    return _ret3 = (_temp3 = (_this3 = _possibleConstructorReturn(this, (_ref3 = Scene.__proto__ || Object.getPrototypeOf(Scene)).call.apply(_ref3, [this].concat(args))), _this3), _this3.attachEvents = function (el) {
      if (el) {
