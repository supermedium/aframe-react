...
exports.Scene = exports.Entity = exports.NamedEntity = exports.Animation = undefined;
...
var NamedEntity = exports.NamedEntity = (function (_React$Component2) {
  _inherits(NamedEntity, _React$Component2);

  function NamedEntity() {
    _classCallCheck(this, NamedEntity);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(NamedEntity).apply(this, arguments));
  }
  ...
  _createClass(NamedEntity, [{
    ...
    value: function render() {
      ...
      var componentProperties = Object.keys(_aframeCore2.default[this.props.mainComponent].schema);
      var mainComponentData = _defineProperty({}, this.props.mainComponent, {});
      var otherComponentData = {};

      Object.keys(this.props).forEach(function (propName) {
        if (propName in componentProperties) {
          mainComponentData[_this3.props.mainComponent][property] = _this3.props[property];
        } else {
          otherComponentData[property] = _this3.props[property];
        }
      });

      return _react2.default.createElement(Entity, _extends({}, mainComponentData, otherComponentData));
    }
  }]);
...
NamedEntity.propTypes = {
  mainComponent: _react2.default.PropTypes.string
};

var Entity = exports.Entity = (function (_React$Component3) {
  _inherits(Entity, _React$Component3);
  ...
  function Entity() {
    ...
    return _ret2 = (_temp2 = (_this4 = _possibleConstructorReturn(this, (_Object$getPrototypeO2 = Object.getPrototypeOf(Entity)).call.apply(_Object$getPrototypeO2, [this].concat(args))), _this4), _this4.attachEvents = function (el) {
  ...
  _createClass(Entity, [{
    ...
    value: function serializeComponents() {
      ...
      Object.keys(this.props).forEach(function (component) {
        ...
        if (_this5.props[component].constructor === Function) {
          return;
        }

        if (_this5.props[component].constructor === Object) {
          // Stringify components passed as object.
          props[component] = _styleAttr2.default.stringify(_this5.props[component]);
        } else {
          // Do nothing for components otherwise.
          props[component] = _this5.props[component];
        }
      });
      return props;
    }
...
var Scene = exports.Scene = (function (_React$Component4) {
  _inherits(Scene, _React$Component4);
  ...
  function Scene() {
    ...
    return _ret3 = (_temp3 = (_this6 = _possibleConstructorReturn(this, (_Object$getPrototypeO3 = Object.getPrototypeOf(Scene)).call.apply(_Object$getPrototypeO3, [this].concat(args))), _this6), _this6.attachEvents = function (el) {
      el.addEventListener('loaded', function (event) {
        _this6.props.onLoaded(event);
      });
      if (_this6.props.onTick) {
        el.addBehavior({
          update: _this6.props.onTick
        });
      }
